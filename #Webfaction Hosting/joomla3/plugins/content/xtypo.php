...
"xtypo_button1" => array("<div style=\" float:left;\"><div style=\"background: url(plugins/content/xtypo/button1/left.gif) top left no-repeat; height:24px; font-size:11px;  line-height:24px; padding-left:10px; overflow:hidden; float:left;\"><div style=\"background: url(plugins/content/xtypo/button1/right.gif) top right no-repeat; font-size:11px;  height:24px; line-height:24px; padding-right:10px; float:left; \">***code***</div></div></div>","#{xtypo_button1}(.*?){/xtypo_button1}#s") ,

"xtypo_button2" => array("
<div style=\" float:left;\"><div style=\"background: url(plugins/content/xtypo/button2/left.gif) top left no-repeat; height:24px; font-size:11px;  line-height:24px; padding-left:10px; overflow:hidden; float:left;\">
<div style=\"background: url(plugins/content/xtypo/button2/right.gif) top right no-repeat; font-size:11px;  height:24px; line-height:24px; padding-right:10px; float:left;\">
	***code***</div></div></div>","#{xtypo_button2}(.*?){/xtypo_button2}#s") ,

"xtypo_button3" => array("
<div style=\" float:left;\"><div style=\"background: url(plugins/content/xtypo/button3/left.gif) top left no-repeat; height:24px; font-size:11px;  line-height:24px; padding-left:10px; overflow:hidden; float:left;\">
<div style=\"background: url(plugins/content/xtypo/button3/right.gif) top right no-repeat; font-size:11px;  height:24px; line-height:24px; padding-right:10px; float:left; \"> 
	***code***</div></div></div>","#{xtypo_button3}(.*?){/xtypo_button3}#s") ,


// start rounded 1
"xtypo_rounded1" => array("<div>
	<div style=\"width:100%;margin:0px auto;background: url(plugins/content/xtypo/rounded1/left.gif) repeat-y left top ".$roundtxtbg1."; \">
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded1/topleft.gif) no-repeat left top;\">
			<span style=\" display:block;position:relative;	height:20px;background:url(plugins/content/xtypo/rounded1/topright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
		<div style=\" position:relative;background:url(plugins/content/xtypo/rounded1/right.gif) repeat-y right top;	padding:1px 20px 1px 25px;	margin:-1px 0 0 0;\">
			<div style=\" color:".$roundtxtcolor1.";\">***code***</div>
		</div>
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded1/bottomleft.gif) no-repeat left bottom;\">
			<span style=\" 	display:block;
	position:relative;
	height:20px;
	background:url(plugins/content/xtypo/rounded1/bottomright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
	</div>
...
<div>
	<div style=\"width:100%;margin:0px auto;background: url(plugins/content/xtypo/rounded2/left.gif) repeat-y left top ".$roundtxtbg2."; \">
...
<div>
	<div style=\"width:100%;margin:0px auto;background: url(plugins/content/xtypo/rounded3/left.gif) repeat-y left top ".$roundtxtbg3."; \">
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded3/topleft.gif) no-repeat left top;\">
			<span style=\" display:block;position:relative;	height:20px;background:url(plugins/content/xtypo/rounded3/topright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
		<div style=\" position:relative;background:url(plugins/content/xtypo/rounded3/right.gif) repeat-y right top;	padding:1px 20px 1px 25px;	margin:-1px 0 0 0;\">
			<div style=\" color:".$roundtxtcolor3.";\">***code***</div>
		</div>
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded3/bottomleft.gif) no-repeat left bottom;\">
			<span style=\" 	display:block;
	position:relative;
	height:20px;
	background:url(plugins/content/xtypo/rounded3/bottomright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
	</div>
...
<div>
	<div style=\"width:100%;margin:0px auto;background: url(plugins/content/xtypo/rounded4/left.gif) repeat-y left top ".$roundtxtbg4."; \">
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded4/topleft.gif) no-repeat left top;\">
			<span style=\" display:block;position:relative;	height:20px;background:url(plugins/content/xtypo/rounded4/topright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
		<div style=\" position:relative;background:url(plugins/content/xtypo/rounded4/right.gif) repeat-y right top;	padding:1px 20px 1px 25px;	margin:-1px 0 0 0;\">
			<div style=\" color:".$roundtxtcolor4.";\">***code***</div>
		</div>
		<div style=\" width:100%;height:20px;background:url(plugins/content/xtypo/rounded4/bottomleft.gif) no-repeat left bottom;\">
			<span style=\" 	display:block;
	position:relative;
	height:20px;
	background:url(plugins/content/xtypo/rounded4/bottomright.gif) no-repeat right top;\">&nbsp;</span>
		</div>
	</div>
