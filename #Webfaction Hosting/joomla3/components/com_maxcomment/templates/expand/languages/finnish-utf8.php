...
DEFINE("_MXC_TPL_KEYWORDS","Hakusanat");
...
DEFINE("_MXC_TPL_SHOW_FORM","[+] Näytä lomake");
DEFINE("_MXC_TPL_HIDE_FORM","[-] Piiloita lomake");
DEFINE("_MXC_TPL_EXPAND_COMMENT","[+] Laajenna kommentti");
DEFINE("_MXC_TPL_COLLAPSE_COMMENT","[-] Kutista kommentti");
