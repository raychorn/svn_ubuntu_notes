...
DEFINE("_MXC_TPL_SHOW_FORM","[+] Mostrar formulario");
DEFINE("_MXC_TPL_HIDE_FORM","[-] Ocultar formulario");
DEFINE("_MXC_TPL_EXPAND_COMMENT","[+] Expandir comentario");
DEFINE("_MXC_TPL_COLLAPSE_COMMENT","[-] Disminuir comentario");
