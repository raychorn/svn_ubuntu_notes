...
ruby_version="1.8.7"
ruby_version_string="1.8.7-p352"
ruby_source_url="http://ftp.ruby-lang.org/pub/ruby/ruby-1.8.7-p352.tar.gz"
ruby_source_tar_name="ruby-1.8.7-p352.tar.gz"
ruby_source_dir_name="ruby-1.8.7-p352"
...
if [ $whichRuby -eq 1 ] ; then
  ...
  echo -e "\n==> done..."
  echo -e "\n=> Using 1.8.7 and setting it as default for new shells..."
